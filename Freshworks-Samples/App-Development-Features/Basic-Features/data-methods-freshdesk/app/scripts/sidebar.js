...
function renderSidebar() {
  ...
  dataMethBtn.addEventListener("fwClick", function getTktDetails() {
    ...
    client.data
      .get("ticket")
      .then(function getDetails({
        ticket: { description_text: desc, priority: priority },
      }) {
    ...
    client.data
      ...
      .then(function getDetails(payload) {
        ...
        space.insertAdjacentHTML(
          "afterbegin",
          `<li><i>"email_config"</i> : <mark>${supportEmail}<mark></li>`
        );
      })
      .catch(console.error);
    ...
    client.data
      ...
      .then(function getDetails(payload) {
        ...
        space.insertAdjacentHTML(
          "afterbegin",
          `<li><i>"requester"</i> : <mark>${name}<mark></li>`
        );
      })
      .catch(console.error);
    ...
    client.data
      ...
      .then(function getDetails(payload) {
        ...
        space.insertAdjacentHTML(
          "afterbegin",
          `<li><i>"company"</i> : <mark>${name}<mark></li>`
        );
      })
      .catch(console.error);
    ...
    client.data
      ...
      .then(function getDetails(payload) {
        ...
        space.insertAdjacentHTML(
          "afterbegin",
          `<li><i>"group"</i> : <mark>${name}<mark></li>`
        );
      })
      .catch(console.error);
    ...
    client.data
      ...
      .then(function getDetails(payload) {
        ...
        space.insertAdjacentHTML(
          "afterbegin",
          `<li><i>"status options"</i> First option: <mark>${opt}<mark></li>`
        );
      })
      .catch(console.error);
