            ...
            function() {
              ...
              .then(function(data) {
                ...
                if (response.length == 0) {
                  document.querySelector('#lfiles').innerHTML += "<div class='alert alert-warning'>No files in your OneDrive.</div>";
                }
                else {
                ...
                document.querySelector('#lfiles').innerHTML += "<div class='alert alert-danger'>Error displaying files</div>";
              });
        });
    });
});
