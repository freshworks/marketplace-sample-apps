             ...
             <tr> 
              <td class="es-p20t es-p20r es-p20l" align="left"> 
               <table cellpadding="0" cellspacing="0" class="es-left" align="left"> 
                 <tr> 
                  <td width="125" class="es-m-p0r es-m-p20b" align="center"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> 
                     <tr> 
                      <td align="center"><a target="_blank"><amp-img class="adapt-img" src="https://eaevfh.stripocdn.email/content/guids/CABINET_b78dc50c5f36a9aa14f13ff1835edef6/images/99111582528108121.png" alt style="display: block;" width="125" height="25" layout="responsive"></amp-img></a></td> 
                     </tr> 
                   </table></td> 
               ...
               <table cellpadding="0" cellspacing="0" class="es-left" align="left"> 
                 <tr> 
                  <td width="125" class="es-m-p20b" align="center"> 
                 ...
                 <tr> 
                  <td width="560" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-p20t" align="left"><p>Hello! Welcome to Freshworks.It's been a month as you have joined the company.We were happy to have you onboard.Hope your experience with us so far has been great. Your feedback on our hiring and on-boarding processes is of paramount importance to better ourselves.We hope you'll help us by taking the survey.Please make some time to fill out the feedback form attached with this email. Hope this suffices.<br></p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
               ...
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="560" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td align="center" class="es-p10"><span class="es-button-border" style="background: #12344d;"><a href="https://docs.google.com/forms/d/1i4jgV7NI5jFBf04KR2fCtb9XEUmPXVswu9BrywZ_D-E/edit" class="es-button" target="_blank" style="background: #12344d; border-color: #12344d;">Take the survey</a></span></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
               ...
               <table cellpadding="0" cellspacing="0" width="100%"> 
                 <tr> 
                  <td width="560" align="center" valign="top"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> 
                     <tr> 
                      <td align="left"><p>Your responses are completely anonymous, and every answer you give will help to make the process better.<br>Thanks,<br>Freshworks Team<br></p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
