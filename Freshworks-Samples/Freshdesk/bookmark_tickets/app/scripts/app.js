                    ...
                    client.request.invoke('getBookmarkedTickets', data)
                        .then(
                            function (response) {
                                ...
                                const agentBookmarkedTicketsTable = document.getElementById('agentBookmarkedTicketsTable');
...
function insertRow(freshdeskDomainName, ticketId, ticketSubject) {
    const table = document.getElementById('agentBookmarkedTicketsTable').insertRow(1);
