  ...
  if (callTicket) {
    ...
    document
      ...
      .addEventListener("click", function () {
        navigateToTicket(callTicket);
      });
  } else {
    document
      .getElementById("createTicket")
      .addEventListener("click", function () {
        createTicketWithCallNotes(false);
      });
  }
}
...
function showCallSummaryScreen() {
  ...
  document.getElementById("callNotesOnSummary").value =
    document.getElementById("callNotes").value;
  document.getElementById("callNotes").value = "";
  document
    .getElementById("btnCreateTicketWithNotes")
    .removeEventListener("click", function () {});
  document
    .getElementById("btnCreateTicketWithNotes")
    .addEventListener("click", function () {
      createTicketWithCallNotes(true);
    });
  document
    .getElementById("btnCancel")
    .removeEventListener("click", endIncompleteCall);
  document
    .getElementById("btnCancel")
    .addEventListener("click", endIncompleteCall);
}
...
function addEventListeners() {
  ...
  document
    ...
    .removeEventListener("click", renderContactList);
  document
    .getElementById("tabContacts")
    .addEventListener("click", renderContactList);
}
