...
exports.receivePayload = (googleLeadsPayload) => {
        constructFreshsalesPayload(googleLeadsPayload);
    }
    // constructing a payload to create a lead in freshsales
const constructFreshsalesPayload = (googleLeadsPayload) => {
        ...
        createLeadinFreshsales(freshsalesCreateLeadPayload)
    }
    // constructing headers and making POST api call to create a lead in Freshsales
function createLeadinFreshsales(freshsalesPayload) {
    let createLeadsUrl = `https://<%= iparam.domain %>.freshsales.io/api/leads`;
    let options = {
        'headers': {
