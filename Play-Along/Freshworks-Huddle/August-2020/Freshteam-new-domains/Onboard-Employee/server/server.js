...
const ERROR_MSG =
  "Seems like either the employee is already an agent or a there has been a DISASTER :(";
...
exports = {
  events: [{ event: "onEmployeeCreate", callback: "onEmployeeCreateHandler" }],
  onEmployeeCreateHandler: async function (args) {
    ...
    // Logging iparams
    console.log(
      "iparams with some secured information are ",
      JSON.stringify(iparams)
    );
