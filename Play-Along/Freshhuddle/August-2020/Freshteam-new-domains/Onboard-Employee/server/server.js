 ...
 * Add or remove the code to make the app fall under both these categories
 */
...
exports = {
  ...
  onEmployeeCreateHandler: async function(args) {
    ...
    // Logging iparams
    console.log('iparams is ', JSON.stringify(iparams));
    ...
    const params = {
      ...
      freshsales: {
        base: `https://${iparams.freshsalesDomain}.freshsales.io/api/v2`,
        encodedApiKey: encode(iparams.freshsalesApiKey)
      },
      freshteam: {
