    ...
    function (_client) {
      ...
      client.events.on("app.activated", function () {
        ...
        document
          ...
          .addEventListener("fwClick", getPerson);
        dispProfiles();
      });
    },
    function (err) {
...
function getPerson() {
  ...
  fetchContactDetails(fullName, email, phone_number)
    .then(function (payload) {
      obj.isDbPresent
        ? updateProfile(fullName, email, phone_number)
        : saveProfile(fullName, email, phone_number);
...
function saveProfile(fullName, email, phone_number) {
  ...
  client.db.set("profiles", createObject).then(
    function () {
...
function updateProfile(fullName, email, phone_number) {
  ...
  client.db.update("profiles", "set", updateObj).then(
    function (data) {
      console.info(data);
    },
    function (error) {
...
function removeProfile(id) {
  client.db.update("profiles", "remove", [id]).then(
    function (data) {
      console.info(data);
    },
    function (error) {
...
function fetchContactDetails(fullName, email, phone_number) {
  ...
  return new Promise(function (resolve) {
    client.request.post(url, opt).then(
      function (data) {
