...
3. Build your [first advanced app](https://freshhuddle.github.io/codelabs/fh1/index.html?index=../..index#0).
    > **NOTE:** Kindly navigate [here](https://github.com/freshdesk/marketplace-sample-apps/tree/master/Play-Along/Exercises/fundamentals/level1) to find the app mentioned in the above tutorial/
4. Install [command line tool - FDK](https://developers.freshdesk.com/v2/docs/quick-start/#install_the_cli)
