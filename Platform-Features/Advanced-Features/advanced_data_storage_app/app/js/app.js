...
function updateAliasValue(key, value) {
    client.db.update(key, 'set', { 'url': value }).then(function (data) {
        client.db.update(key, 'increment', { 'updates': 1 }).then(function (data) {
...
function makeInterfaceAPI(data) {
    client[data.api][data.action](data.method, data.payload).then(function (result) {
